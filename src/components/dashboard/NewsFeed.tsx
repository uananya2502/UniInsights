    ...
    <div className="card animate-slide-up">
      <div className="card-header flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="card-title">Live Higher Education News</h3>
            <p className="text-xs text-slate-500 mt-0.5">Real-time headlines from NDTV, The Hindu, Times of India & Indian Express</p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {articles.map((article) => (
              <a
                ...
                className="block group p-3.5 rounded-md border border-slate-200/80 bg-white hover:border-blue-500 hover:shadow-xs transition-all cursor-pointer"
              >
                ...
                <h4 className="text-xs font-bold text-slate-900 group-hover:text-blue-600 transition-colors mb-1 leading-snug">
                  {article.title}
                </h4>
